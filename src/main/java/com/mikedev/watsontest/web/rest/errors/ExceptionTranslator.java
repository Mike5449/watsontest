package com.mikedev.watsontest.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.mikedev.watsontest.service.EmailAlreadyUsedException ||
            ex instanceof com.mikedev.watsontest.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.mikedev.watsontest.service.InvalidPasswordException
